...
This node is the coordinator of the execution of the task.
...
class GoalManagementNode:
    def __init__(self):
        ...
        self.exploration_command_pub = rospy.Publisher('/exploration_command', String, queue_size=50)

        # Publisher to send to node_A the apriltags positions, when all requested tags are detected
        self.final_results_pub = rospy.Publisher('/final_cube_positions', PoseArray, queue_size=50)
        ...
        # publisher to tilt the camera of Tiago
        self.head_pub = rospy.Publisher('/head_controller/command', JointTrajectory, queue_size=50) # to move the camera angle
    ...
    def start(self):
        ...
        self.status_pub.publish(String(data="360° INITIAL ROTATION."))  # update node_A about the new tag found.status_pub
